...
class NotamParserTest
{
    ...
    void parseValidNotam()
    {
        ...
        assertEquals( Instant.parse( "2025-08-19T17:55:00.000Z" ), n
                .getIssued() );
    ...
    void parsesNotamWithOnlyLocalTranslation()
    {
        ...
        assertEquals( Instant.parse( "2026-04-30T22:00:00.000Z" ), n
                .getEffectiveEnd() );
        assertEquals(
                "TWY A BTN TWY A4 AND TWY A6 WIP ADJ EAST SIDE LGTD AND BARRICADED",
                n.getText() );
    ...
    void parsesFirstPartQLine()
    {
        ...
        List<Notam> result = assertDoesNotThrow( () -> parser.parseNotams(
                json ) );
