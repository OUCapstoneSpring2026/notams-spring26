...
public class AirportValidator
{
    ...
    public AirportValidator() throws IOException
    {
    ...
    /**
     * Checks whether the given ICAO code exists in the airport coordinates map.
     *
     * @param icao
     *     the ICAO code to look up (case-sensitive; should be uppercase)
     *
     * @return {@code true} if the code is found in the map, {@code false}
     *     otherwise
     */
    public boolean icaoExists( final String icao )
    {
        return icaoCoordsMap.containsKey( icao );
    }

    /**
     * Resolves a raw ICAO input string to a standardized 4-character ICAO code.
     *
     ...
     * the {@code K}-prefixed form. If both exist, an exception is thrown due to
     * ambiguity. If exactly one exists, that form is returned.</li>
     ...
     *
     * @return the resolved, standardized ICAO code (e.g. {@code "KJFK"})
     *
     * @throws AirportNotFoundException
     *     if the code cannot be found, is ambiguous,
     *     or has an unsupported length
     */
    public String parseIcaoInput( final String icao ) throws AirportNotFoundException
    {
     ...
     *
     * @param icao
     *     the 4-character ICAO code to look up (e.g. {@code "KJFK"})
     *
     ...
     */
    public Point2D getCoordsForIcao( final String icao ) throws AirportNotFoundException
    {
        final Point2D coords = icaoCoordsMap.get( icao );
        if( coords == null ) {
