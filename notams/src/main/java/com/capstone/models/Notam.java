 ...
 * vary
 * by NOTAM type/source. The builder keeps object creation readable (vs. a huge
 * constructor)
 * while still enforcing required fields (like id) at build time.
 */
